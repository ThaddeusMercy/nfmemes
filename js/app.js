...
.from('.slide', { duration: 1, x: '-100vw', ease: 'power.in'})
.from('.slide-up', {duration: 1, y: '-100vw', ease: 'power.in'})
.from('.slide-vid', {duration: 1, x: '-100vw', ease: 'power.in'})
.from('.slide-gal', {duration: 1, x: '100vw', ease: 'power.in'})
